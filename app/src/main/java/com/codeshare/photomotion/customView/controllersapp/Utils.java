...
public class Utils {
    ...
    public static AlertDialog alertaProfessional;
    ...
    public Utils(Context context) {
        ...
        dirShareFiles = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "Photo Motion");
    ...
    public static void abrirProfessional(Activity activity) {
        String string = activity.getResources().getString(R.string.preference_file_key);
        try {
            ...
            sb2.append(string);
            abrirURL(sb2.toString(), activity);
        }
    }
    ...
    public static void showMensagemProfessional(final Activity activity) {
        ...
        if (alertDialog == null || !alertDialog.isShowing()) {
            alertaProfessional = new AlertDialog.Builder(activity).setTitle(activity.getString(R.string.msg_professional_titulo)).setMessage(activity.getString(R.string.msg_professional_mensagem)).setCancelable(true).setPositiveButton(activity.getString(R.string.msg_professional_confirm), new DialogInterface.OnClickListener() {
    ...
    public static boolean verificarPermissao(final Activity activity, final String[] strArr, String str, String str2, final int i, MotionEditActivity.ListenerPermissao listenerPermissao) {
        boolean z = true;
        boolean z2 = false;
        ...
        if (z) {
            ...
            new AlertDialog.Builder(activity).setTitle(str).setMessage(str2).setPositiveButton(R.string.botao_ok, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static class C02642 implements OnScanCompletedListener {
    ...
    public static class C02653 implements DialogInterface.OnClickListener {
        public void onClick(DialogInterface dialogInterface, int i) {
        }
    }
}
